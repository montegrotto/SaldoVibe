...
- Månatligt driftskript: `scripts/monthly_restore_dry_run.sh`, som nu även kör
  ...
  dedikerad Ofelia-`scheduler`-tjänst i `docker-compose.prod.yml` kör det månadsvis inuti
